...
use App\Http\Requests\Products\PropertyValues\ProductPropertyValueStoreRequest;
use App\Http\Requests\Products\PropertyValues\ProductPropertyValueUpdateRequest;
use App\Models\ProductPropertyValue;
use App\Services\ProductPropertyValueService;
...
class ProductPropertyValueController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.products.property-values.index', compact('productPropertyValues'));
    }
    ...
    {
        return view('pages.products.property-values.create');
    }
    ...
    public function store(ProductPropertyValueStoreRequest $request)
    {
        ...
        return redirect()->route('product-property-values.index');
    }
    ...
    {
        return view('pages.products.property-values.show', compact('productPropertyValue'));
    }
    ...
    {
        return view('pages.products.property-values.edit', compact('productPropertyValue'));
    }
